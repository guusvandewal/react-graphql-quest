    ...
    <main className="min-h-screen">
      ...
      <header className="border-b">
        <div className="container py-16 max-w-5xl">
          <Badge variant="outline" className="mb-4">React · TypeScript · GraphQL</Badge>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Learn <span className="gradient-text">GraphQL + TypeScript</span> by reading one app
          </h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
            A pure React app — no Apollo, no codegen — that fetches real data
            from a public GraphQL API and shows the most common TypeScript
            patterns you'll meet on the job.
          </p>
        </div>
      </header>
      ...
      <div className="container py-12 max-w-5xl space-y-16">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">
            GraphQL is just an HTTP <code className="inline-code">POST</code>{" "}
            with a JSON body containing a <code className="inline-code">query</code> string.
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">
            The hook returns <code className="inline-code">{`{ status, data, error }`}</code>.
            We render a different UI for each value of <code className="inline-code">status</code>.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            Five quick questions covering the patterns used in this app. Pick the
            answer you think is right — explanations appear instantly.
          </p>
          ...
          <div className="grid gap-4">
            ...
            <Challenge
              ...
              options={["Pick<Country, 'name'>", "Omit<Country, 'name'>", "Partial<Country>", "Readonly<Country>"]}
              correctIndex={2}
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">
            Open <code className="inline-code">src/types.ts</code> and try these
            on your own. Solutions below — no peeking!
          </p>
  ...
  currency: string;
      ...
      <footer className="border-t mt-16">
        <div className="container py-8 max-w-5xl text-sm text-muted-foreground">
          Data from <a className="underline hover:text-foreground" href="https://countries.trevorblades.com" target="_blank" rel="noreferrer">countries.trevorblades.com</a> · Built with React + Vite.
        </div>
      </footer>
    </main>
  );
